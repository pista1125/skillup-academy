...
export const mathTopics: MathTopic[] = [
  ...
  },
  {
    ...
    description: 'Számfogalom 0-tól 5-ig, számok írása, bontása, összeadás és kivonás 5-ös számkörben',
    icon: '🖐️',
  ...
  },
  {
    id: 'g1-geometry',
    title: 'IV. GEOMETRIA',
    description: 'Vonalak, síkidomok és térbeli testek felfedezése, csoportosítása és építések',
    icon: '📐',
  ...
  },
  {
    id: 'g1-measurements',
    title: 'V. MÉRÉSEK',
    description: 'A hosszúság, tömeg, űrtartalom és az idő mérése, összehasonlítása',
    icon: '📏',
    color: 'from-cyan-500 to-blue-500',
    grades: [1],
  },
  {
    id: 'g1-numbers-to-20',
    title: 'VI. SZÁMKÖRBŐVÍTÉS, SZÁMOLÁS 20-IG',

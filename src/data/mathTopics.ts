...
export const mathTopics: MathTopic[] = [
  ...
  {
    id: 'g2-numbers-to-50',
    title: 'II. SZÁMKÖRBŐVÍTÉS ÉS SZÁMOLÁS 50-IG',
  ...
  },
  {
    ...
    title: 'III. SZÁMKÖRBŐVÍTÉS ÉS SZÁMOLÁS 100-IG',
  ...
  },
  {
    ...
    title: 'IV. SZORZÁS',
    description: 'Szorzótáblák 2-től 10-ig, szorzási szabályok, stratégiák és játékos gyakorlás',
    icon: '✖️',
    color: 'from-amber-500 to-orange-600',
    grades: [2],
  },
  {
    id: 'g2-division',
    title: 'V. OSZTÁS',
    description: 'Bennfoglalás és osztótáblák 2-től 10-ig, részekre osztás és ellenőrzés',
    icon: '➗',
  ...
  },
  {
    id: 'g2-measurements',
    title: 'VIII. MÉRÉSEK',
    description: 'Hosszúság, tömeg és űrtartalom mérése, mértékegységek és átváltások',
    icon: '📏',
    color: 'from-cyan-500 to-blue-500',
    grades: [2],
  },

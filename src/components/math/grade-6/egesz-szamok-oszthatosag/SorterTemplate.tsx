                ...
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : 'bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 hover:border-cyan-400 hover:bg-cyan-50/50'
                  )}
                >
                  {item.label}
                </button>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                selectedItem
                  ? 'border-cyan-400 dark:border-cyan-500 bg-cyan-50/20 dark:bg-cyan-950/20 cursor-pointer hover:bg-cyan-50/40'
            ...
            >
              ...
              {selectedItem && (
                <Button
                  ...
                  className="w-full mt-3 h-8 rounded-xl font-bold text-xs bg-cyan-600 hover:bg-cyan-700 text-white"
                >
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          {!validationResult.isAllCorrect ? (
            <Button
              onClick={handleCheck}
              disabled={!allPlaced}
              className="w-full sm:w-auto h-10 px-6 rounded-xl font-bold text-xs sm:text-sm bg-cyan-600 hover:bg-cyan-700 text-white shadow-sm"
            >
            ...
            <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
              ...
              {onSwitchToTheory && (
                <Button
                  ...
                  className="h-10 px-4 rounded-xl font-bold text-xs sm:text-sm text-cyan-600 dark:text-cyan-400 hover:bg-cyan-50 dark:hover:bg-cyan-950/40"
                >

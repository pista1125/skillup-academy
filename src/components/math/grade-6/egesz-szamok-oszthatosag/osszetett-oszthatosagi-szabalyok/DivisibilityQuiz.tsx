...
interface DivisibilityQuizProps {
    onBack?: () => void;
}
...
export function DivisibilityQuiz({ onBack }: DivisibilityQuizProps = {}) {
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            {onBack && (
                                <Button
                                    variant="outline"
                                    onClick={onBack}
                                    className="w-full h-12 text-sm font-bold rounded-2xl border-slate-200"
                                >
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            {onBack && (
                <div className="flex items-center justify-between bg-white/50 p-4 rounded-2xl border border-rose-100 shadow-sm mb-2">
                    <div className="flex items-center gap-3">
                        <div className="p-2.5 bg-rose-100 rounded-xl text-rose-600">
                            <Sparkles className="w-5 h-5" />
                        </div>
                        <div>
                            <h3 className="font-bold text-base text-slate-800">Oszthatósági Kvíz</h3>
                            <p className="text-xs text-slate-500">Összetett oszthatósági szabályok tesztelése</p>
                        </div>
                    </div>
                    <Button variant="outline" onClick={onBack} size="sm" className="rounded-xl">
                        <ArrowLeft className="w-4 h-4 mr-2" />
                        Vissza
                    </Button>
                </div>

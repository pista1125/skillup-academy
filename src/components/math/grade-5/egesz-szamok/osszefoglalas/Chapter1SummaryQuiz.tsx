...
import { QuizTemplate, QuizLevelConfig, CheatSheetItem, DifficultyLevel, QuizQuestion } from '../QuizTemplate';
import { Chapter1SummaryMatcher } from './Chapter1SummaryMatcher';
import { Chapter1SummarySorter } from './Chapter1SummarySorter';

export { type DifficultyLevel, type QuizQuestion };

export interface Chapter1SummaryQuizProps {
  onBack: () => void;
  onSwitchToTheory?: () => void;
}

export const CHAPTER1_SUMMARY_CHEAT_SHEET: CheatSheetItem[] = [
  {
...
export const CHAPTER1_SUMMARY_LEVELS: Record<DifficultyLevel, QuizLevelConfig> = {
  1: {
    level: 1,
...
export function Chapter1SummaryQuiz({
  onBack,
  onSwitchToTheory
  ...
  return (
    <QuizTemplate
      ...
      badgeColor="purple"
      levels={CHAPTER1_SUMMARY_LEVELS}
      cheatSheet={CHAPTER1_SUMMARY_CHEAT_SHEET}
      onBack={onBack}
      onSwitchToTheory={onSwitchToTheory}
      matcherComponent={<Chapter1SummaryMatcher onBack={onBack} onSwitchToTheory={onSwitchToTheory} />}
      sorterComponent={<Chapter1SummarySorter onBack={onBack} onSwitchToTheory={onSwitchToTheory} />}
    />
  );
}

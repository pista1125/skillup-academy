...
interface OppositeAbsoluteSorterProps {
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : 'bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 hover:border-orange-300 dark:hover:border-orange-600'
                  )}
                >
                  {item.label}
                </button>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                selectedItem
                  ? 'border-dashed border-orange-400 dark:border-orange-500 bg-orange-50/20 dark:bg-orange-950/10 cursor-pointer hover:bg-orange-50/40'
            ...
            >
              ...
              {selectedItem && (
                <div className="mt-3 pt-2 border-t border-slate-200 dark:border-slate-800 text-center text-xs font-bold text-orange-600 dark:text-orange-400">
            ...
            >
              {validationResult.isAllCorrect ? (
                <>
                  ...
                  Tökéletes! Minden elem a helyes kategóriába került!
                </>
              ) : (
                <>
                  <XCircle className="w-4 h-4 text-rose-600" />
                  Még van {validationResult.mistakesCount} tévesen elhelyezett elem! Kattints a piros elemekre a visszavonáshoz.
                </>
              )}
            </div>
          )}
        ...
        <div className="flex items-center gap-3">
          {!validationResult.isAllCorrect ? (
            <Button
              onClick={handleCheck}
              disabled={!allPlaced}
              className="rounded-2xl h-10 px-6 font-bold bg-orange-600 hover:bg-orange-700 text-white shadow-md shadow-orange-500/20 disabled:opacity-50"
            >

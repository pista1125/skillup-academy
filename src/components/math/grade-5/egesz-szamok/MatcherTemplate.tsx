            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  card.isMatched
                    ? 'bg-amber-50 dark:bg-amber-950/40 border-amber-400/80 text-amber-700 dark:text-amber-300 opacity-80 cursor-default scale-95'
                    : isFlipped
                    ? card.type === 'prompt'
                    ...
                    : 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-amber-400 dark:hover:border-amber-500 hover:shadow-xs hover:-translate-y-0.5 active:translate-y-0'
                )}
              >
                {isFlipped ? (
                  ...
                  <div className="flex flex-col items-center gap-1.5 text-slate-400 dark:text-slate-500">
                    <Sparkles className="w-4 h-4 opacity-40 text-amber-500" />

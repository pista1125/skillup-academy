...
export interface IntegerAdditionSubtractionSorterProps {
  onBack: () => void;
  onSwitchToQuiz?: () => void;
...
export function IntegerAdditionSubtractionSorter({
  ...
  return (
    <SorterTemplate
      title="Egész számok összeadása és kivonása - Csoportosító Játék"
...
export default IntegerAdditionSubtractionSorter;

...
import { CheckCircle2, XCircle, ArrowRight, Trophy, RotateCcw, ArrowLeft, Shapes, Sparkles, HelpCircle } from 'lucide-react';
...
const QUESTIONS: Question[] = [
  {
    id: 'pa1',
    category: 'Téglalap átlója',
    question: 'Egy téglalap alakú telek oldalai a = 30 m és b = 40 m. Milyen hosszú a telek átlója?',
    options: ['50 m', '70 m', '45 m', '60 m'],
    correctIndex: 0,
    explanation: 'd² = a² + b² = 30² + 40² = 900 + 1600 = 2500 => d = √2500 = 50 m.'
  },
  {
    id: 'pa2',
    category: 'Négyzet átlója',
    question: 'Egy négyzet oldala a = 6 cm. Mennyi az átlójának pontos hossza?',
    options: ['6√2 cm (≈ 8,49 cm)', '12 cm', '36 cm', '6√3 cm'],
    correctIndex: 0,
    explanation: 'd² = a² + a² = 2a² => d = a√2 = 6√2 cm.'
  },
  {
    id: 'pa3',
    category: 'Egyenlő szárú háromszög magassága',
    ...
    correctIndex: 0,
    explanation: 'A magasság felezi az alapot: a/2 = 6 cm. A derékszögű háromszögből: m² + 6² = 10² => m² = 100 - 36 = 64 => m = 8 cm.'
  },
  {
    id: 'pa4',
    category: 'Szabályos háromszög magassága',
    question: 'Egy 10 cm oldalú szabályos (egyenlő oldalú) háromszög magassága pontosan:',
    options: ['5√3 cm (≈ 8,66 cm)', '5 cm', '5√2 cm', '8 cm'],
    correctIndex: 0,
    explanation: 'Szabályos háromszög magassága: m = (a√3) / 2 = (10√3) / 2 = 5√3 cm.'
  },
  {
    id: 'pa5',
    category: 'Rombusz oldala',
    question: 'Egy rombusz átlói e = 16 cm és f = 12 cm. Mekkora a rombusz oldala (a)?',
    options: ['10 cm', '14 cm', '20 cm', '8 cm'],
    correctIndex: 0,
    explanation: 'A rombusz átlói merőlegesen felezik egymást: a befogók e/2 = 8 cm és f/2 = 6 cm. a² = 8² + 6² = 64 + 36 = 100 => a = 10 cm.'
  },
  {
    id: 'pa6',
    category: 'Szimmetrikus trapéz (húrtrapéz)',
    question: 'Egy szimmetrikus trapéz alapjai a = 20 cm és c = 8 cm, szárai b = 10 cm. Mekkora a trapéz magassága (m)?',
    options: ['8 cm', '6 cm', '7 cm', '9 cm'],
    correctIndex: 0,
    explanation: 'A szár alatti kis szakasz: x = (a - c) / 2 = (20 - 8) / 2 = 6 cm. m² + 6² = 10² => m² = 100 - 36 = 64 => m = 8 cm.'
  }
];

export function PythagorasApplicationsQuiz({ onComplete, onBack }: PythagorasApplicationsQuizProps) {
    ...
    return (
      <div className="max-w-xl mx-auto text-center py-6 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
          <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-amber-500 to-emerald-600 flex items-center justify-center text-white shadow-lg shadow-amber-200">
            <Trophy className="w-10 h-10" />
          </div>

          <h2 className="text-3xl font-black text-slate-800 mb-2">
            {percentage >= 80 ? 'Alkalmazási Zseni!' : percentage >= 60 ? 'Szép eredmény!' : 'Gyakorolj még!'}
          </h2>
          <p className="text-sm text-slate-500 mb-6 font-medium">4. A Pitagorasz-tétel alkalmazása kvíz befejezve</p>
    ...
    <div className="max-w-2xl mx-auto py-4">
      ...
      <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-slate-100 space-y-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <span className="text-xs font-bold text-amber-600 uppercase tracking-wider">4. Fejezet • Síkbeli Alkalmazások</span>

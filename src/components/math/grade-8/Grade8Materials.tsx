...
import { GRADE_8_MATERIALS, Material } from './tananyagok/materials';

interface Grade8MaterialsProps {
    onView?: (material: Material) => void;
}

export const Grade8Materials: React.FC<Grade8MaterialsProps> = ({ onView }) => {
    return (
        <div className="space-y-6">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-6 text-white shadow-lg">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-black">8. Osztályos Matematika Tananyagok</h2>
                </div>
                <p className="text-blue-100 text-sm max-w-2xl">
                    Hivatalos tankönyvek, munkafüzetek és középiskolai felvételi felkészítő anyagok 8. évfolyam számára (NAT 2020).
                </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {GRADE_8_MATERIALS.map((material) => (
                    <Card
                        key={material.id}
...
export default Grade8Materials;

...
import { CheckCircle2, XCircle, ArrowRight, Trophy, RotateCcw, ArrowLeft, TrendingUp, Sparkles, HelpCircle } from 'lucide-react';
import { cn } from '@/lib/utils';

interface DirectProportionG8QuizProps {
...
const QUESTIONS: Question[] = [
  {
    id: 'dp1',
    category: 'Arányossági tényező',
    question: 'Két mennyiség, x és y között egyenes arányosság áll fenn. Ha x = 4 esetén y = 14, mennyi az arányossági tényező (k = y / x)?',
    options: ['3,5', '2,8', '10', '56'],
    correctIndex: 0,
    explanation: 'Egyenes arányosságnál a hányados állandó: k = y / x = 14 / 4 = 3,5. A hozzárendelés: y = 3,5x.'
  },
  {
    id: 'dp2',
    category: 'Grafikon jellegzetessége',
    question: 'Milyen alakú az egyenes arányosság grafikonja a koordináta-rendszerben?',
    options: [
      'Origón (0; 0) átmenő egyenes',
      'Hiperbola görbe',
      'Parabola görbe',
      'Vízszintes egyenes az x tengely felett'
    ],
    correctIndex: 0,
    explanation: 'Az y = k · x képletből látszik, hogy ha x = 0, akkor y = 0, tehát a grafikon mindig egy origón átmenő egyenes.'
  },
  {
    id: 'dp3',
    category: 'Hiányzó érték kiszámítása',
    question: 'Egy gép 15 perc alatt 45 dobozt csomagol be. Hány dobozt csomagol be 40 perc alatt állandó sebességgel?',
    options: ['120 dobozt', '100 dobozt', '135 dobozt', '80 dobozt'],
    correctIndex: 0,
    explanation: '1 perc alatt: 45 / 15 = 3 doboz. 40 perc alatt: 40 · 3 = 120 doboz.'
  },
  {
    id: 'dp4',
    category: 'Hozzárendelési szabály felírása',
    question: 'Egy gépkocsi 100 kilométerenként átlagosan 6,5 liter üzemanyagot fogyaszt. Melyik képlet adja meg az x km megtételéhez szükséges y liter üzemanyagot?',
    options: ['y = 0,065x', 'y = 6,5x', 'y = 100 / (6,5x)', 'y = x / 6,5'],
    correctIndex: 0,
    explanation: '1 km-re jutó fogyasztás: 6,5 / 100 = 0,065 liter/km. Így y = 0,065 · x.'
  },
  {
    id: 'dp5',
    category: 'Meredekség és irány',
    question: 'Ha az y = k · x hozzárendelésben k = -2, hogyan viselkedik a grafikon?',
    options: [
      'Szigorúan monoton csökken (balról jobbra lefelé halad)',
      'Szigorúan monoton nő',
      'Vízszintes vonal marad',
      'Felfelé nyíló parabola'
    ],
    correctIndex: 0,
    explanation: 'Negatív meredekség (k < 0) esetén az x növekedésével az y csökken, vagyis a függvény csökkenő, az egyenes lejt.'
  },
  {
    id: 'dp6',
    category: 'Egyenes arányosság felismerése',
    question: 'Melyik állítás ír le EGYENES ARÁNYOSSÁGOT az alábbiak közül?',
    options: [
      'A megvásárolt benzin mennyisége és a fizetendő összeg rögzített literenkénti ár mellett.',
      'Egy téglalap szélessége és hosszúsága rögzített terület mellett.',
      'A munkások száma és az árokásás ideje.',
      'Egy ember életkora és a testmagassága.'
    ],
    correctIndex: 0,
    explanation: 'Ha kétszer annyi benzint tankolunk, pontosan kétszer annyit fizetünk: a hányados (literár) állandó, ez egyenes arányosság.'
  }
];

export function DirectProportionG8Quiz({ onComplete, onBack }: DirectProportionG8QuizProps) {
      ...
      <div className="max-w-xl mx-auto text-center py-6 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
          ...
          <h2 className="text-3xl font-black text-slate-800 mb-2">
            {percentage >= 80 ? 'Arányosság Bajnok!' : percentage >= 60 ? 'Szép eredmény!' : 'Gyakorolj még!'}
          </h2>
          <p className="text-sm text-slate-500 mb-6 font-medium">1. Egyenes arányosság kvíz befejezve</p>
    ...
    <div className="max-w-2xl mx-auto py-4">
      ...
      <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-slate-100 space-y-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <span className="text-xs font-bold text-cyan-600 uppercase tracking-wider">1. Fejezet • Egyenes Arányosság</span>
...
export default DirectProportionG8Quiz;

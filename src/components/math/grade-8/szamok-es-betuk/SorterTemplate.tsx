                ...
                <button
                  ...
                  className={cn(
                    ...
                    isSelected
                      ...
                      : 'bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 hover:border-blue-400 hover:bg-blue-50/50'
                  )}
                >
                  {item.label}
                </button>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                selectedItem
                  ? 'border-blue-400 dark:border-blue-500 bg-blue-50/20 dark:bg-blue-950/20 cursor-pointer hover:bg-blue-50/40'
            ...
            >
              ...
              {selectedItem && (
                <Button
                  ...
                  className="w-full mt-3 h-8 rounded-xl font-bold text-xs bg-blue-600 hover:bg-blue-700 text-white"
                >
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          {!validationResult.isAllCorrect ? (
            <Button
              onClick={handleCheck}
              disabled={!allPlaced}
              className="w-full sm:w-auto h-10 px-6 rounded-xl font-bold text-xs sm:text-sm bg-blue-600 hover:bg-blue-700 text-white shadow-sm"
            >

  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-300">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
          ...
          {onSwitchToTheory && (
            <Button
              ...
              className="rounded-xl h-8 px-2.5 text-xs font-bold gap-1 text-violet-600 dark:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-950/40"
            >
              <BookOpen className="w-3.5 h-3.5" />
              Tananyag
            </Button>
      ...
      {!isCompleted ? (
        ...
        /* Completion Screen */
        <div className="bg-gradient-to-b from-violet-50/80 to-white dark:from-slate-850 dark:to-slate-900 border-2 border-violet-300 dark:border-violet-800/80 rounded-3xl p-6 sm:p-8 text-center space-y-6 shadow-xl animate-in zoom-in-95 duration-300">
          <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-amber-400 to-violet-600 text-white flex items-center justify-center mx-auto shadow-lg shadow-violet-500/30">
          ...
          <div className="flex items-center justify-center gap-4 max-w-xs mx-auto">
            <div className="p-3 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 flex-1">
              ...
              <div className="text-lg font-black text-violet-600 dark:text-violet-400 font-mono">
                {formatTime(seconds)}
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 pt-2">
            ...
            {activeLevel < 3 && onNextLevel && (
              <Button
                onClick={onNextLevel}
                className="rounded-xl h-10 px-5 font-bold bg-violet-600 hover:bg-violet-700 text-white shadow-md text-xs sm:text-sm"
              >
            ...
            {onSwitchToTheory && (
              <Button
                variant="ghost"
                onClick={onSwitchToTheory}
                className="rounded-xl h-10 px-4 font-bold text-xs sm:text-sm text-violet-600 dark:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-950/40"
              >

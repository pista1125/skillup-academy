...
import { CheckCircle2, XCircle, ArrowRight, Trophy, RotateCcw, ArrowLeft, Zap, Sparkles, HelpCircle } from 'lucide-react';
...
const QUESTIONS: Question[] = [
  {
    id: 'p1',
    category: 'Azonos alapú hatványok szorzása',
    question: 'Egyszerűsítsd a hatványt: 2⁴ · 2⁵ = ?',
    options: ['2⁹', '2²⁰', '4⁹', '4²⁰'],
    correctIndex: 0,
    explanation: 'Azonos alapú hatványok szorzásakor az alapot változatlanul hagyjuk, a kitevőket összeadjuk: 2⁴ · 2⁵ = 2⁴⁺⁵ = 2⁹.'
  },
  {
    id: 'p2',
    category: 'Azonos alapú hatványok osztása',
    question: 'Mennyi a 3⁷ : 3⁴ kifejezés értéke egyszerűbb hatványalakban?',
    options: ['3³ (= 27)', '3¹¹', '1³', '3²⁸'],
    correctIndex: 0,
    explanation: 'Azonos alapú hatványok osztásakor a kitevőket kivonjuk: 3⁷ : 3⁴ = 3⁷⁻⁴ = 3³ = 27.'
  },
  {
    id: 'p3',
    category: 'Hatvány hatványozása',
    question: 'Írd fel egyetlen hatványként: (5³)² = ?',
    options: ['5⁵', '5⁶', '5⁹', '25³'],
    correctIndex: 1,
    explanation: 'Hatvány hatványozásakor a kitevőket összeszorozzuk: (5³)² = 5³·² = 5⁶.'
  },
  {
    id: 'p4',
    category: 'Negatív kitevő',
    question: 'Mennyi a 2⁻³ szám pontos értéke tört alakban?',
    options: ['-8', '-6', '1/8', '1/6'],
    correctIndex: 2,
    explanation: 'A negatív kitevő definíciója: a⁻ⁿ = 1/aⁿ. Tehát 2⁻³ = 1/(2³) = 1/8.'
  },
  {
    id: 'p5',
    category: 'Számok normálalakja',
    question: 'Mi a 450 000 szám helyes normálalakja?',
    options: ['45 · 10⁴', '4,5 · 10⁵', '4,5 · 10⁶', '0,45 · 10⁶'],
    correctIndex: 1,
    explanation: 'A normálalak a · 10ᵏ alakú, ahol 1 ≤ a < 10. Ezért a = 4,5, a tizedesvesszőt 5 hellyel toljuk balra: 4,5 · 10⁵.'
  },
  {
    id: 'p6',
    category: 'Műveletek normálalakkal',
    question: 'Mennyi a (3 · 10⁴) · (2 · 10³) szorzat normálalakban?',
    options: ['6 · 10¹²', '6 · 10⁷', '5 · 10⁷', '6 · 10¹'],
    correctIndex: 1,
    explanation: '(3 · 10⁴) · (2 · 10³) = (3 · 2) · (10⁴ · 10³) = 6 · 10⁴⁺³ = 6 · 10⁷.'
  },
  {
    id: 'p7',
    category: 'Tört negatív kitevőn',
    question: 'Mennyi a (2/3)⁻² hatvány értéke?',
    options: ['-4/9', '4/9', '9/4', '-9/4'],
    correctIndex: 2,
    explanation: '(a/b)⁻ⁿ = (b/a)ⁿ. Tehát (2/3)⁻² = (3/2)² = 9/4 = 2,25.'
  },
  {
    id: 'p8',
    category: '0 kitevő',
    question: 'Mennyi az értéke: (-15)⁰ + 7⁰ - (1/2)⁰ = ?',
    options: ['1', '0', '-1', '14'],
    correctIndex: 0,
    explanation: 'Bármely nemnulla szám 0. hatványa 1. Tehát 1 + 1 - 1 = 1.'
  }
];

export function PowersQuiz({ onComplete, onBack }: PowersQuizProps) {
      ...
      <div className="max-w-xl mx-auto text-center py-6 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
          ...
          <h2 className="text-3xl font-black text-slate-800 mb-2">
            {percentage >= 80 ? 'Hatványozás Mestere!' : percentage >= 60 ? 'Szép eredmény!' : 'Gyakorolj még!'}
          </h2>
          <p className="text-sm text-slate-500 mb-6 font-medium">6. Hatványozás kvíz befejezve</p>
    ...
    <div className="max-w-2xl mx-auto py-4">
      ...
      <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-slate-100 space-y-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <span className="text-xs font-bold text-amber-600 uppercase tracking-wider">6. Fejezet • Hatványozás</span>

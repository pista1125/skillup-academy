...
import { CheckCircle2, XCircle, ArrowRight, Trophy, RotateCcw, ArrowLeft, Scissors, Sparkles, HelpCircle } from 'lucide-react';
...
const QUESTIONS: Question[] = [
  {
    id: 'f1',
    category: 'Egytagú szorzása egytagúval',
    question: 'Mennyi a (3a²) · (-4a³) szorzat eredménye?',
    options: ['-12a⁵', '-12a⁶', '7a⁵', '-1a⁵'],
    correctIndex: 0,
    explanation: 'Együtthatók: 3 · (-4) = -12. Változók: a² · a³ = a²⁺³ = a⁵. Eredmény: -12a⁵.'
  },
  {
    id: 'f2',
    category: 'Zárójelbontás',
    question: 'Bontsd fel a zárójelet: -3x · (2x - 5) = ?',
    options: ['-6x² - 15x', '-6x² + 15x', '6x² - 15x', '-6x + 15'],
    correctIndex: 1,
    explanation: '(-3x) · 2x = -6x², és (-3x) · (-5) = +15x. Összesen: -6x² + 15x.'
  },
  {
    id: 'f3',
    category: 'Közös tényező kiemelése',
    question: 'Alakítsd szorzattá a legnagyobb közös rész kiemelésével: 12x² - 18x = ?',
    options: ['6x · (2x - 3)', '6 · (2x² - 3x)', '3x · (4x - 6)', '2x · (6x - 9)'],
    correctIndex: 0,
    explanation: 'A 12 és 18 legnagyobb közös osztója 6. Az x² és x közül a legkisebb kitevőjű az x. Kiemelve a 6x-et: 6x(2x - 3).'
  },
  {
    id: 'f4',
    category: 'Többváltozós kiemelés',
    question: 'Alakítsd szorzattá: 8a³b² + 12a²b³ = ?',
    options: [
      '4a²b² · (2a + 3b)',
      '4ab · (2a²b + 3ab²)',
      '2a²b² · (4a + 6b)',
    ...
    correctIndex: 0,
    explanation: 'A legnagyobb közös szám 4. A betűs részben a² és b² emelhető ki: 4a²b²(2a + 3b).'
  },
  {
    id: 'f5',
    category: 'Negatív előjel kiemelése',
    question: 'Mi lesz az eredmény, ha a -5x - 10 kifejezésből kiemeljük a -5-öt?',
    options: ['-5 · (x + 2)', '-5 · (x - 2)', '-5 · (x - 10)', '5 · (-x - 2)'],
    correctIndex: 0,
    explanation: 'Negatív szám kiemelésekor a zárójelen belüli minden előjel megfordul: -5x : (-5) = x, és -10 : (-5) = +2. Eredmény: -5(x + 2).'
  },
  {
    id: 'f6',
    category: 'Zárójelbontás és összevonás',
    question: 'Egyszerűsítsd: 2(3x - 4) - 3(x - 2) = ?',
    options: ['3x - 2', '3x - 14', '3x + 2', '9x - 14'],
    correctIndex: 0,
    explanation: 'Bontás: 6x - 8 - 3x + 6. Összevonás: (6x - 3x) + (-8 + 6) = 3x - 2.'
  }
];

export function FactoringQuiz({ onComplete, onBack }: FactoringQuizProps) {
      ...
      <div className="max-w-xl mx-auto text-center py-6 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
          ...
          <h2 className="text-3xl font-black text-slate-800 mb-2">
            {percentage >= 80 ? 'Kiemelés Nagymester!' : percentage >= 60 ? 'Szép eredmény!' : 'Gyakorolj még!'}
          </h2>
          <p className="text-sm text-slate-500 mb-6 font-medium">10. Betűs kifejezések szorzása és a kiemelés kvíz befejezve</p>
    ...
    <div className="max-w-2xl mx-auto py-4">
      ...
      <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-slate-100 space-y-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <span className="text-xs font-bold text-indigo-600 uppercase tracking-wider">10. Fejezet • Szorzás és Kiemelés</span>

    ...
    return (
      ...
      >
          ...
          <div className="flex items-center gap-2">
            ...
            {onSwitchToTheory && (
              <Button
                ...
                className="rounded-xl h-8 px-2.5 text-xs font-bold text-violet-700 bg-violet-50/50 border-violet-200 dark:bg-violet-950/40 dark:text-violet-300 dark:border-violet-800 hover:bg-violet-100"
              >
        ...
        <div className="text-center max-w-2xl mx-auto mb-3 sm:mb-4">
          <div className="text-[11px] font-black uppercase tracking-wider text-violet-600 dark:text-violet-400 mb-0.5">
            {topicBadge || badgeText || '8. Osztály • Matematika'}
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
                {cheatSheet.map((item, idx) => (
                  <div key={idx} className="bg-white/95 dark:bg-slate-800/95 p-2.5 rounded-xl border border-violet-100 dark:border-slate-700 shadow-xs text-left">
                    <div className="text-xs font-black text-violet-600 dark:text-violet-400">{item.topic}</div>
                ...
                <div>
                  ...
                  <div className="space-y-1.5 pt-2.5 border-t border-slate-100 dark:border-slate-800 mb-3">
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-bold text-violet-600 dark:text-violet-400 text-right truncate max-w-[140px]" title={cfg.focus}>{cfg.focus}</span>
                    </div>
                  </div>

...
const QUESTIONS: Question[] = [
  {
    id: 'geoeq1',
    category: 'Háromszög szögei',
    question: 'Egy háromszög szögeinek aránya 2 : 3 : 5. Mekkora a háromszög legnagyobb szöge?',
    options: ['90°', '80°', '100°', '75°'],
    correctIndex: 0,
    explanation: '2x + 3x + 5x = 180° => 10x = 180° => x = 18°. A legnagyobb szög 5 · 18° = 90° (tehát ez egy derékszögű háromszög!).'
  },
  {
    id: 'geoeq2',
    category: 'Téglalap kerülete',
    ...
    correctIndex: 0,
    explanation: 'Kerület = 2(a + b) => 2(x + x + 6) = 48 => 4x + 12 = 48 => 4x = 36 => x = 9 cm. (Oldalak: 9 cm és 15 cm).'
  },
  {
    id: 'geoeq3',
    category: 'Egyenlő szárú háromszög',
    ...
    correctIndex: 0,
    explanation: 'Alap = x, szár = x + 5. Kerület: x + 2(x + 5) = 34 => 3x + 10 = 34 => 3x = 24 => x = 8 cm. (A szárak 13 cm-esek).'
  },
  {
    id: 'geoeq4',
    category: 'Területváltozás',
    ...
    correctIndex: 0,
    explanation: '(x + 3)² - x² = 39 => x² + 6x + 9 - x² = 39 => 6x + 9 = 39 => 6x = 30 => x = 5 cm. (Ellenőrzés: 8² - 5² = 64 - 25 = 39).'
  },
  {
    id: 'geoeq5',
    category: 'Trapéz alapjai',
    question: 'Egy trapéz területe 60 cm², magassága 6 cm. Az egyik párhuzamos alapja kétszer akkora, mint a másik. Mekkora a hosszabbik alap?',
    options: ['13,33 cm (vagy 40/3 cm)', '15 cm', '12 cm', '16 cm'],
    correctIndex: 0,
    explanation: 'T = ((a + c) · m) / 2 => 60 = ((x + 2x) · 6) / 2 => 60 = 3x · 3 = 9x => x = 60 / 9 = 20 / 3 cm. A hosszabb alap 2 · (20/3) = 40/3 ≈ 13,33 cm.'
  },
  {
    id: 'geoeq6',
    category: 'Derékszögű háromszög hegyesszögei',
    question: 'Egy derékszögű háromszög egyik hegyesszöge 24°-kal nagyobb a másiknál. Mekkora a kisebbik hegyesszög?',
    options: ['33°', '57°', '38°', '28°'],
    correctIndex: 0,
    explanation: 'A két hegyesszög összege 90°: x + (x + 24°) = 90° => 2x + 24° = 90° => 2x = 66° => x = 33°. (A másik szög 57°).'
  }
];

export function GeometricEquationsQuiz({ onComplete, onBack }: GeometricEquationsQuizProps) {
      ...
      <div className="max-w-xl mx-auto text-center py-6 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
          ...
          <h2 className="text-3xl font-black text-slate-800 mb-2">
            {percentage >= 80 ? 'Geometriai Egyenlet Profi!' : percentage >= 60 ? 'Szép eredmény!' : 'Gyakorolj még!'}
          </h2>
          <p className="text-sm text-slate-500 mb-6 font-medium">5. Szöveges geometriai feladatok kvíz befejezve</p>
    ...
    <div className="max-w-2xl mx-auto py-4">
      ...
      <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-slate-100 space-y-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <span className="text-xs font-bold text-emerald-600 uppercase tracking-wider">5. Fejezet • Geometriai Egyenletek</span>

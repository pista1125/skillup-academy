...
import { CheckCircle2, XCircle, ArrowRight, Trophy, RotateCcw, ArrowLeft, Coins, Sparkles, HelpCircle } from 'lucide-react';
...
const QUESTIONS: Question[] = [
  {
    id: 'fin1',
    category: 'Egymást követő árváltozások',
    question: 'Egy cipő árát 20%-kal megemelték, majd az új árat 20%-kal leértékelték. Hogyan változott az eredeti árhoz képest?',
    options: ['4%-kal csökkent', 'Változatlan maradt', '2%-kal csökkent', '4%-kal nőtt'],
    correctIndex: 0,
    explanation: 'x · 1,20 · 0,80 = 0,96x. Mivel 0,96 = 96%, az ár 4%-kal alacsonyabb az eredetinél.'
  },
  {
    id: 'fin2',
    category: 'Eredeti ár visszaszámolása',
    question: 'Egy nadrág árát 25%-kal csökkentették a kiárusításon, így 12 000 Ft-ba kerül. Mennyi volt az eredeti ára?',
    options: ['16 000 Ft', '15 000 Ft', '14 400 Ft', '18 000 Ft'],
    correctIndex: 0,
    explanation: '0,75 · x = 12 000 => x = 12 000 / 0,75 = 16 000 Ft.'
  },
  {
    id: 'fin3',
    category: 'Egyszerű kamatszámítás',
    question: 'Befektetünk 200 000 Ft-ot évi 6%-os kamatra 3 évre egyszerű kamatozással. Mennyi kamatot kapunk a 3 év alatt összesen?',
    options: ['36 000 Ft', '12 000 Ft', '24 000 Ft', '40 000 Ft'],
    correctIndex: 0,
    explanation: 'Kamat = (Tőke · Kamatláb · Évek) / 100 = (200 000 · 6 · 3) / 100 = 36 000 Ft.'
  },
  {
    id: 'fin4',
    category: 'Haszon és beszerzési ár',
    question: 'Egy kereskedő 20%-os haszonnal adta el a terméket 48 000 Ft-ért. Mennyi volt a beszerzési ára?',
    options: ['40 000 Ft', '38 400 Ft', '42 000 Ft', '36 000 Ft'],
    correctIndex: 0,
    explanation: 'Beszerzési ár · 1,20 = 48 000 => Beszerzési ár = 48 000 / 1,20 = 40 000 Ft.'
  },
  {
    id: 'fin5',
    category: 'Féléves kamat',
    question: 'Lekötünk 500 000 Ft-ot évi 8%-os kamatra fél évre (6 hónapra). Mennyi lesz a teljes felvehető összeg kamattal együtt?',
    options: ['520 000 Ft', '540 000 Ft', '510 000 Ft', '580 000 Ft'],
    correctIndex: 0,
    explanation: 'Fél évre a kamat az éves kamat fele: 500 000 · 0,08 · 0,5 = 20 000 Ft. Teljes felvehető összeg: 500 000 + 20 000 = 520 000 Ft.'
  },
  {
    id: 'fin6',
    category: 'Megtakarítás tervezése',
    question: 'Dani egy 72 000 Ft-os játékkonzolra gyűjt. Már van 24 000 Ft-ja, és hetente 4 000 Ft zsebpénzt tud félretenni. Hány hét múlva tudja megvenni a konzolt?',
    options: ['12 hét múlva', '10 hét múlva', '14 hét múlva', '18 hét múlva'],
    correctIndex: 0,
    explanation: '24 000 + 4 000x = 72 000 => 4 000x = 48 000 => x = 12 hét.'
  }
];

export function FinancialProblemsQuiz({ onComplete, onBack }: FinancialProblemsQuizProps) {
      ...
      <div className="max-w-xl mx-auto text-center py-6 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
          ...
          <h2 className="text-3xl font-black text-slate-800 mb-2">
            {percentage >= 80 ? 'Pénzügyi Guru!' : percentage >= 60 ? 'Szép eredmény!' : 'Gyakorolj még!'}
          </h2>
          <p className="text-sm text-slate-500 mb-6 font-medium">7. Pénzügyi feladatok kvíz befejezve</p>
    ...
    <div className="max-w-2xl mx-auto py-4">
      ...
      <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-slate-100 space-y-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <span className="text-xs font-bold text-amber-600 uppercase tracking-wider">7. Fejezet • Pénzügyi Feladatok</span>
